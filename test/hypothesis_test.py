...
# For the string test, whenever alignment is requested, explicitly request the type of alignment.
# pyfmt has a default alignment of right aligned for both strings and numbers, but Python has a
# defalt alignment of right for numbers, and a default alignment of left for strings, despite
# the PEP3101 documentation saying that the alignment is left by default.
@given(text(alphabet=string.printable, max_size=10),
