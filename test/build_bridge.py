...
int FormatOneIntError(char* p0, int p1);
int FormatOneFloatError(char* p0, float p1);
int FormatOneDoubleError(char* p0, double p1);
int FormatOneStringError(char* p0, char* p1);
int FormatNothingError(char* p0);
""")
